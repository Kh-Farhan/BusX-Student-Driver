...
router.get("/viewRoute/:ins",studentController.getRouteFunction);
router.post("/changeRoute",studentController.changeRouteFunction);
router.get("/getData/",studentController.getDataFunction);
...
router.post("/selRoute",studentController.selRoute);
